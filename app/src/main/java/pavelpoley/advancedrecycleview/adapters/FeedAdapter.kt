...
import kotlinx.android.synthetic.main.item_feed_ad.view.*
...
class FeedAdapter(frag: FragmentActivity, list: ArrayList<FeedModel>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (position == 0) {
            ...
            holder.itemView.textView2.text = mList[position].title
        }else{
            holder.itemView.tv_feed_main_desc.text = mList[position].name
        }
    }
